      ...
      <>
              ...
              if(form.type === 'text' || form.type === 'email') {
                return (
                      <div className="form-group mb-3">
                          ...
                          <input type={form.type} placeholder={form.placeholder} className="form-control" name={form.name} />
                      </div>
                )
              } else if (form.type === 'url') {
                return (
                  <>
                  <label for="basic-url" className="form-label">{form.label}</label><label class="form-text">{form.text}</label>
                ...
                return (
                        <div className="col-6" >
                          <div className="card mb-4 btn-card">
           ...
           {props.buttonTitle !== 'Launch Eden' ? 
            <button type="submit" 
              ...
              className="btn btn-primary col-xl-12 col-lg-12 col-md-12 col-sm-12" 
              onClick={props.onclick}>{props.buttonTitle} </button> : null}
